    ...
    <div className="track-cc-cont">
      <div className="track-cc-top">
        ...
        <div className="track-cc-top-head">
          <b>Full Stack Developer</b> Course Curriculum
        </div>
      </div>
      ...
      <div className="track-cc-btm">
        <div className="track-cc-btm-card">
          ...
          <div className="track-cc-btm-card-text">
            DBMS
            <span>
              Proficiency in Database Management Systems stands as a skill set
              essential for excelling in interviews, especially within the
              startup environment.
            </span>
          </div>
        </div>
