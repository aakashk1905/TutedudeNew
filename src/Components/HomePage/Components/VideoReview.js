  ...
  return (
    <div className="vr-cont">
      ...
      <div className="vr-scroll-cont">
        <div className="vr-card" style={{ marginLeft: "50px" }}>
          <div className="vr-card-inner">
            ...
            <div className="vr-name-cont">
              <div className="vr-name">Aarti Singh</div>
              <div className="vr-post">UI UX Designer</div>
            </div>
          </div>
        </div>
        ...
        <div className="vr-card" style={{ marginRight: "50px" }}>
          <div className="vr-card-inner">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
